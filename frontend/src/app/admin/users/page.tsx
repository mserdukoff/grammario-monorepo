        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-border/50">
              {filtered.map(u => (
                <tr key={u.id} className="hover:bg-surface-2 transition-colors">
                  ...
                  <td className="px-4 py-3 text-xs">
                    <span className="text-warning font-mono">{u.streak}</span>
                    <span className="text-[10px] text-muted-foreground ml-1">(best: {u.longest_streak})</span>
                  </td>
                  ...
                  <td className="px-4 py-3 text-[10px] text-muted-foreground">{u.last_active_date || "Never"}</td>
              ...
              {filtered.length === 0 && (
                <tr><td colSpan={9} className="px-4 py-12 text-center text-muted-foreground text-sm">No users found</td></tr>
              )}
            </tbody>
          </table>
        </div>
